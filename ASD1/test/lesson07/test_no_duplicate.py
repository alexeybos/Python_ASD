...
from ASD1.test.lesson07.no_duplicate import OrderedList
...
class TestOrderedList(TestCase):
    ...
    def test_delete_duplicates_asc(self):
        ordered_list = OrderedList(True)
        ordered_list.add(9)
        ordered_list.add(9)
        ordered_list.add(9)
        ...
        ordered_list.add(10)
        ordered_list.add(10)
        self.assertEqual(8, ordered_list.len())
        self.assertEqual(8, self.reverse_len(ordered_list))
        ordered_list.delete_duplicates()
        self.assertEqual(3, ordered_list.len())
        self.assertEqual(3, self.reverse_len(ordered_list))



    def test_delete_duplicates_desc(self):
        ordered_list = OrderedList(False)
        ordered_list.add(9)
        ordered_list.add(9)
        ordered_list.add(9)
    ...
    def test_check_sub_list_in_list(self):
        ordered_list = OrderedList(True)
        ordered_list.add(9)
        ordered_list.add(4)
        ordered_list.add(6)
        ordered_list.add(11)
        self.assertTrue(ordered_list.check_sub_list_in_list([6, 9]))
        self.assertTrue(ordered_list.check_sub_list_in_list([6, 9, 11]))
        self.assertTrue(ordered_list.check_sub_list_in_list([4, 6, 9, 11]))

        self.assertFalse(ordered_list.check_sub_list_in_list([6, 9, 10]))
        self.assertFalse(ordered_list.check_sub_list_in_list([5, 10]))
    ...
    def test_find_most_frequent(self):
        ...
        ordered_list.add(4)
        ordered_list.add(4)
        self.assertEqual(4, ordered_list.find_most_frequent())
        ordered_list.add(9)
        self.assertEqual(4, ordered_list.find_most_frequent())
        ordered_list.add(9)
        ordered_list.add(10)
        self.assertEqual(9, ordered_list.find_most_frequent())
    ...
    def test_get_index(self):
        ...
        ordered_list.add(5)
        ordered_list.add(7)
        self.assertEqual(0, ordered_list.get_index(4))
        self.assertEqual(1, ordered_list.get_index(5))
        self.assertEqual(2, ordered_list.get_index(7))
        self.assertEqual(3, ordered_list.get_index(9))